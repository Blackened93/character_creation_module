...
def attack(char_name: str, char_class: str) -> str:
    """Определение количества нанесённого урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определение количества блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определение применения специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Определение начала тренировки с выполнением выбранного действия."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор класса персонажа на старте игры."""
    approve_choice: str = ''
    char_class: str = ''
